...
def euler_method(f, x0=0, y0=0, tamaño_paso=0.1, numero_pasos=5):
# =============================================================================
#     esta funcion recibe los datos iniciales de x & y, tambien el tamaño de paso y número de pasos,
...
euler_method(evaluar_ecuacion, x0, y0, tamaño_paso, numero_pasos)